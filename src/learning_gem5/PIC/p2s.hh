...
// P2SWritePayload (the wire format for a bit-plane WRITE on cb_port) lives
// in pic_dpm_types.hh -- it's shared with AccessBankArb, which parses this
// exact struct off the packet (see AccessBankArb::handleRequest()).
    ...
    class P2S_L : public ClockedObject {
        private:
            ...
            class MemSidePort : public RequestPort
            {
                private:
                    P2S_L *owner;
                    // true for DMAPort, false for CacheBankPort -- lets the
                    // shared recvTimingResp()/recvReqRetry() bodies below
                    // tell the two instances apart.
                    bool dmaSide;
                public:
                    MemSidePort(const std::string& name, P2S_L *owner, bool dmaSide);
        ...
        private:
            ...
            class MemSidePort : public RequestPort
            {
                private:
                    ...
                    bool dmaSide;
                public:
                    MemSidePort(const std::string& name, P2S_R_T *owner, bool dmaSide);
                    void sendPacket(PacketPtr pkt);
